...
use FilmTools\Commons\ExposuresFactory;
...
class ExposuresFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $sut = new ExposuresFactory;
        $exposures = $sut->fromValues( $data );
        ...
        $exposure_values = iterator_to_array( $exposures );
